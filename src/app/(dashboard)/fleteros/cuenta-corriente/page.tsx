/**
 * Propósito: Página de cuenta corriente de fleteros (ruta /fleteros/cuenta-corriente).
...
/**
 * FleterosCuentaCorrientePage: () -> Promise<JSX.Element>
 *
 ...
 * Existe como alias de /cuentas-corrientes bajo la ruta /fleteros/cuenta-corriente.
 *
 * Ejemplos:
 * // Sesión ADMIN_TRANSMAGG → CuentasCorrientesClient con datos
 * <FleterosCuentaCorrientePage />
 * // Sin sesión → redirect /login
 * <FleterosCuentaCorrientePage />
 */
export default async function FleterosCuentaCorrientePage() {
