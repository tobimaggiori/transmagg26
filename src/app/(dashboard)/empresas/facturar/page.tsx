/**
 * Propósito: Página de facturación rápida (ruta /empresas/facturar).
 ...
 * Existe como entry point de creación de facturas bajo /empresas/facturar.
 *
 * Ejemplos:
 * // Sesión ADMIN_TRANSMAGG → lista de empresas con botón Nueva Factura
