/**
 * Propósito: Página de consulta del historial de facturas a empresas (/empresas/facturas).
 ...
 * // Sesión ADMIN_EMPRESA → redirigido por falta de permiso interno (puedeAcceder)
 * // o con datos de su empresa
 * <EmpresasFacturasPage />
