 ...
 *
 * Usa los mismos helpers (datosAsientoCompra) que la pantalla y el PDF.
 */
...
export async function GET(request: NextRequest): Promise<Response> {
  ...
  try {
    ...
    const headerRow = ws.addRow(["Fecha", "Proveedor", "CUIT", "Tipo cbte.", "Número", "Neto Gravado", "IVA", "Alícuota %"])
