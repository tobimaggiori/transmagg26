/**
 * API Route: GET /api/contabilidad/iva-compras-alicuota/excel
 * Genera IVA Compras agrupado por Tipo Cbte → Alícuota como Excel.
...
export async function GET(request: NextRequest): Promise<Response> {
  ...
  try {
    ...
    const ws = wb.addWorksheet("Compras por Alícuota")
    ...
    return new Response(ab, {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="iva-compras-alicuota-${periodoLabel}.xlsx"`,
      },
    })
  } catch (error) {
    return serverErrorResponse("GET /api/contabilidad/iva-compras-alicuota/excel", error)
  }
}
