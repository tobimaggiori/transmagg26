...
// ═══════════════════════════════════════════════════════════════════════════════
// BORRADOR y ANULADA no existen en labels de UI
// ═══════════════════════════════════════════════════════════════════════════════

describe("CONGELADO: BORRADOR y ANULADA no aparecen en labels de comprobantes", () => {
  ...
  it("labelEstadoLiquidacion no reconoce ANULADA como estado válido", () => {
    expect(labelEstadoLiquidacion("ANULADA")).toBe("ANULADA") // fallback crudo
  })

  it("labelEstadoFactura no reconoce ANULADA como estado válido", () => {
    expect(labelEstadoFactura("ANULADA")).toBe("ANULADA") // fallback crudo
  })
})
