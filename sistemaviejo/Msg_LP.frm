...
Begin VB.Form Msg_LP 
   ...
   Begin KewlButtonz.KewlButtons Opcion 
      ...
      MCOL            =   4210752
      MPTR            =   1
      MICON           =   "Msg_LP.frx":0000
      PICN            =   "Msg_LP.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons Opcion 
      ...
      MCOL            =   4210752
      MPTR            =   1
      MICON           =   "Msg_LP.frx":0A2E
      PICN            =   "Msg_LP.frx":0A4A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons Opcion 
      ...
      MCOL            =   4210752
      MPTR            =   1
      MICON           =   "Msg_LP.frx":145C
      PICN            =   "Msg_LP.frx":1478
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons Opcion 
      ...
      MCOL            =   4210752
      MPTR            =   1
      MICON           =   "Msg_LP.frx":1E8A
      PICN            =   "Msg_LP.frx":1EA6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
If Index = 1 Then
    Call Imprime_LP(NroLP)
ElseIf Index = 0 Then
    Dim frmRep As New InfFacturaComis
    frmRep.Show vbModal
