...
Begin VB.Form ABMProvincias 
   BackColor       =   &H80000007&
   Caption         =   "ABM Proviancias"
   ClientHeight    =   2280
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   6105
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin KewlButtonz.KewlButtons Modificar 
         ...
         MCOL            =   4210752
         MPTR            =   1
         MICON           =   "ABMProvincias.frx":0000
         PICN            =   "ABMProvincias.frx":001C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons Buscar 
         ...
         MCOL            =   4210752
         MPTR            =   1
         MICON           =   "ABMProvincias.frx":562E
         PICN            =   "ABMProvincias.frx":564A
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons Aceptar 
         ...
         MCOL            =   4210752
         MPTR            =   1
         MICON           =   "ABMProvincias.frx":7354
         PICN            =   "ABMProvincias.frx":7370
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons Cancelar 
         ...
         MCOL            =   4210752
         MPTR            =   1
         MICON           =   "ABMProvincias.frx":93F2
         PICN            =   "ABMProvincias.frx":940E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons Command1 
         ...
         MCOL            =   4210752
         MPTR            =   1
         MICON           =   "ABMProvincias.frx":99A8
         PICN            =   "ABMProvincias.frx":99C4
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "ABMProvincias"
...
Text1(0) = rsProvincias!DescProv
CtaCont = rsProvincias!CtaCont
...
If Accion = "Nuevo" Then
    Set rsProvincias = db.OpenRecordset("Provincias", 1, 1)
    lPrimaryKey = GetPrimaryKey
    With rsProvincias
        .AddNew
        .Fields("CodProv") = lPrimaryKey
        .Fields("DescProv") = Text1(0)
    ...
    MsgBox "Provincia Agregada Correctamente", vbInformation
    Text1(0).SetFocus
Exit Sub
AltaProv:
    TableError Err
...
If Accion = "Buscar" Then
    Set rsProvincias = db.OpenRecordset("Select * from Provincias Where DescProv Like '*" & Text1(0) & "*'")
    If Not rsProvincias.EOF And Not rsProvincias.BOF Then
...
If Accion = "Modificar" Then
    rsProvincias.Fields("DescProv") = Text1(0)
    rsProvincias.Fields("CtaCont") = CtaCont
    rsProvincias.Update
    rsProvincias.LockEdits = False
    Set rsProvincias = Nothing
    Text1(0) = "": Text1(1) = ""
    CtaCont.Mask = "": CtaCont.Text = "": CtaCont.Mask = "#.#.#.##.###"
    MsgBox "Provincia  Modificada Correctamente", vbInformation
    Text1(0).SetFocus
...
Private Function GetPrimaryKey()
    ...
    With rsProvincias
        ...
        If (Not (.EOF And .BOF)) Then
            ...
            GetPrimaryKey = .Fields("CodProv") + 1
