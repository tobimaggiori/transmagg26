...
Begin VB.Form InfViajesPendEmp 
   Caption         =   "Viajes Sin Facturar por Empresa"
   ClientHeight    =   5130
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10395
   ...
   End
End
Attribute VB_Name = "InfViajesPendEmp"
...
Set crReporte = crapp.OpenReport(App.Path & "\ViajesPendEmpresa.rpt", 1)
