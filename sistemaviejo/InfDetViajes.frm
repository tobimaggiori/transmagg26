...
Begin VB.Form InfDetViajes 
   Caption         =   "Detalles de Viajes por Fleteros"
   ClientHeight    =   5625
   ClientLeft      =   60
   ClientTop       =   390
   ClientWidth     =   10305
   ...
   End
End
Attribute VB_Name = "InfDetViajes"
...
Set crReporte = crapp.OpenReport(App.Path & "\ViajesFlet.rpt", 1)
