...
Begin VB.Form infDetalleGastos 
   Caption         =   "Detalle Gastos por Rubro"
   ClientHeight    =   4530
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   8865
   ...
   End
End
Attribute VB_Name = "infDetalleGastos"
...
Set crReporte = crapp.OpenReport(App.Path & "\DetalleGastos.rpt", 1)
