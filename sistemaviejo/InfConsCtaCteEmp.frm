...
Begin VB.Form InfConsCtaCteEmp 
   Caption         =   "Consulta Cuenta Corriente Empresas"
   ClientHeight    =   5685
   ClientLeft      =   60
   ClientTop       =   390
   ClientWidth     =   10275
   ...
   End
End
Attribute VB_Name = "InfConsCtaCteEmp"
...
Set crReporte = crapp.OpenReport(App.Path & "\ConsCtaCte.rpt", 1)
