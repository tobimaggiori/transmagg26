...
Begin VB.Form FacturarViajes1 
   BackColor       =   &H80000007&
   Caption         =   "Factura Viajes y ingresadas"
   ClientHeight    =   9060
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   14025
   ...
   Begin KewlButtonz.KewlButtons OkViajes 
      ...
      MCOL            =   4210752
      MPTR            =   1
      MICON           =   "FacturarViajes1.frx":0000
      PICN            =   "FacturarViajes1.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons Aceptar 
      ...
      MCOL            =   4210752
      MPTR            =   1
      MICON           =   "FacturarViajes1.frx":0A2E
      PICN            =   "FacturarViajes1.frx":0A4A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons Cancelar 
      ...
      MCOL            =   4210752
      MPTR            =   1
      MICON           =   "FacturarViajes1.frx":2ACC
      PICN            =   "FacturarViajes1.frx":2AE8
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "FacturarViajes1"
