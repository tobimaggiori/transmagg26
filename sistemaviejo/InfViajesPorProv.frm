...
Begin VB.Form InfViajesPorProv 
   Caption         =   "Informe de Viajes por Provincias"
   ClientHeight    =   5265
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10230
   ...
   End
End
Attribute VB_Name = "InfViajesPorProv"
...
Set crReporte = crapp.OpenReport(App.Path & "\ViajesProvincia.rpt", 1)
