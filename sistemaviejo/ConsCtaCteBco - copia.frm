...
Do While Not rsCtaCteBco.EOF
    ...
    Lista.SubItems(2) = rsConsBco!descconcepto
    Set rsComprobantes = Nothing
    Lista.SubItems(3) = rsCtaCteBco!NroMov
    If Not rsCtaCteBco!Debe = "" Then
        Lista.SubItems(4) = FormatNumber(rsCtaCteBco!Debe)
        VSaldo = VSaldo + rsCtaCteBco!Debe
    End If
    If Not rsCtaCteBco!HABER = "" Then
        Lista.SubItems(5) = FormatNumber(rsCtaCteBco!HABER)
        VSaldo = VSaldo - rsCtaCteBco!HABER
    End If
    Lista.SubItems(6) = FormatNumber(VSaldo)
    Lista.SubItems(7) = rsCtaCteBco!Obs
