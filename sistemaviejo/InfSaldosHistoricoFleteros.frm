...
Begin VB.Form InfSaldosHistoricoFleteros 
   Caption         =   "Saldos Historicos Fleteros"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "InfSaldosHistoricoFleteros"
...
Set crReporte = crapp.OpenReport(App.Path & "\InfSaldosHistoricos-Fleteros.rpt", 1)
