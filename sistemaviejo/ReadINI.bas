...
Public lPrimaryKey As Long
Public rs As Recordset
Public Items As Long
Public VNROOP As Double
Public TrsEncabOP As Recordset
Public rsConsBco As Recordset
...
Public TrsLPVsFact As Recordset
...
Public rsDetOPAdel As Recordset
Public rsViajes_SFact As Recordset
Public TrsViajes As Recordset
...
Public rsEncab_LP As Recordset
Public rsDet_LP As Recordset
Public rsViajes As Recordset
Public rsViajesFlet As Recordset
Public TrsDescDet As Recordset
Public TrsIVAVentas As Recordset
Public TrsConsultas As Recordset
Public TrsEncabFactCta As Recordset
Public TrsDetFactCta As Recordset
Public TrsAplicRec As Recordset
...
Public rsEncabMutuo As Recordset
Public rsCHRecMutuo As Recordset
Public rsCHEntMutuo As Recordset
Public TrsCHEmitidos As Recordset
Public rsViajesFact As Recordset
Public rsEncabAdel As Recordset
Public rsDetAdelCHP As Recordset
Public rsDetAdelCHT As Recordset
Public TrsChoferes As Recordset
Public TrsHistoricos As Recordset
Public TrsGastosConceptos As Recordset

Public rsSaldoCero As Recordset
...
Public VCodflet As Long
Public ConsNroViaje As Double
Public NroQR As String


Public Function DBPath() As String
    DBPath = App.Path + "\BaseDatos\DB_TRANS-MAGG.mdb"
End Function
