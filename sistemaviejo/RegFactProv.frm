...
With rsEncabFactProv
    ...
    .Fields("PercIIBB") = FormatNumber(Text1(7))
    .Fields("LIVA") = "SI"
    .Update
End With
...
If Not Text1(4) = "" Or Not Text1(6) = "" Or Not Text1(7) = "" Then
    cant = DetFact.ListItems.Count
    i = 0
    For i = i + 1 To cant
        Set Lista = DetFact.ListItems.Item(i - 1)
        If Lista.Tag = Text1(4) Then
            MsgBox "No se puede repetir conceptos"
            Exit Sub
        End If
    Next
...
Select Case Index
    Case 7:
            IVA = Val(Text1(7)) * Val(Text1(6)) / 100
            STotal = Val(Text1(7)) + IVA
