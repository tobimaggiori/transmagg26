...
Begin VB.Form Msg_Adel 
   BackColor       =   &H00000000&
   Caption         =   "Mensaje Adelanto"
   ClientHeight    =   2535
   ClientLeft      =   60
   ClientTop       =   420
   ClientWidth     =   6000
   ...
   Begin KewlButtonz.KewlButtons Opcion 
      ...
      MCOL            =   4210752
      MPTR            =   1
      MICON           =   "Msg_Adel.frx":0000
      PICN            =   "Msg_Adel.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons Opcion 
      ...
      MCOL            =   4210752
      MPTR            =   1
      MICON           =   "Msg_Adel.frx":0A2E
      PICN            =   "Msg_Adel.frx":0A4A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
