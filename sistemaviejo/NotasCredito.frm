...
Begin VB.Form NotasCredito 
   BackColor       =   &H80000007&
   Caption         =   "Confeccion de Notas de Credito"
   ClientHeight    =   6330
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   7890
   ...
   Begin KewlButtonz.KewlButtons AgregarCHP 
      ...
      MCOL            =   4210752
      MPTR            =   1
      MICON           =   "NotasCredito.frx":0000
      PICN            =   "NotasCredito.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons Aceptar 
      ...
      MCOL            =   4210752
      MPTR            =   1
      MICON           =   "NotasCredito.frx":209E
      PICN            =   "NotasCredito.frx":20BA
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons Cancelar 
      ...
      MCOL            =   4210752
      MPTR            =   1
      MICON           =   "NotasCredito.frx":413C
      PICN            =   "NotasCredito.frx":4158
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "NotasCredito"
...
If NCFE.iniciar(modoFiscal_Fiscal, "30709381683", App.Path + "\Certificado\Certificado.pfx", App.Path + "\Certificado\WSAFIPFE.lic") Then
   ...
   If NCFE.f1ObtenerTicketAcceso() Then
      ...
      NCFE.F1CabeceraPtoVta = Text1(13)
...
On Error Resume Next
    ...
    Set rsEncabFact = db.OpenRecordset("Select * from EncabFE Where TipoSistema = 17 and PtoVtaFE = " & Text1(13) & " order by NroFe")
...
On Error Resume Next
    Dim DescCliente As String, CuitClient As String, DirCliente As String, LocCliente As String
    Set rsEncabFact = db.OpenRecordset("Select * from EncabFE Where TipoSistema = 203 and PtoVtaFe = " & Text1(13) & " order by NroFe")
    Set rsDetFact = db.OpenRecordset("DetFE")
    Set TrsEncabFact = dbTemp.OpenRecordset("EncabFact")
    Set TrsDetFact = dbTemp.OpenRecordset("DetFact")
    'limpia temporales
