...
Begin VB.Form FactViajesDirecto 
   BackColor       =   &H80000007&
   Caption         =   "Factura Viajes Direcoto Trans-MAgg"
   ClientHeight    =   9975
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   14115
   ...
   Begin KewlButtonz.KewlButtons OkViajes 
      ...
      MCOL            =   4210752
      MPTR            =   1
      MICON           =   "FactViajesDirecto.frx":0000
      PICN            =   "FactViajesDirecto.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons Aceptar 
      ...
      MCOL            =   4210752
      MPTR            =   1
      MICON           =   "FactViajesDirecto.frx":0A2E
      PICN            =   "FactViajesDirecto.frx":0A4A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons Cancelar 
      ...
      MCOL            =   4210752
      MPTR            =   1
      MICON           =   "FactViajesDirecto.frx":2ACC
      PICN            =   "FactViajesDirecto.frx":2AE8
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "FactViajesDirecto"
...
For Items = Items + 1 To LViajesFact.ListItems.Count
    ...
    rsLiqDetViajes.LockEdits = True
    rsLiqDetViajes.Fields("Facturado") = "SI"
    rsLiqDetViajes.Fields("FacturadoEn") = VtipoComp & "  / 4-" & lPrimaryKey
    rsLiqDetViajes.Update
    rsLiqDetViajes.LockEdits = False
Next
    'GRABA FACTURA EN CTA CTE
...
Set rsEncabFact = db.OpenRecordset("Select * from EncabFE Where TipoSistema = 201 order by NroFe")
Set rsDetFact = db.OpenRecordset("DetFE")
Set TrsEncabFact = dbTemp.OpenRecordset("EncabFact")
Set TrsDetFact = dbTemp.OpenRecordset("DetFact")
Set rsAsientos = db.OpenRecordset("Asientos")
