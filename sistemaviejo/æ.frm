...
'busca liquidos productos
    ...
    Do While Not rsEncabFactProv.EOF
         comislp = rsEncabFactProv!TotalComis
        ...
        Else
            ...
            Do While Not rsDet_LP.EOF
               ...
               'End If
                ...
                gralcomis = FormatNumber(gralcomis + vTotalcomis)
                .Fields("Neto") = vcomis
                    .Fields("Exento") = "0.00"
            ...
            End With
        End If
       If gralcomis = comislp Then
       Else
            MsgBox "Diferencia en LP:" & rsEncabFactProv!NroComp & "Diferencia: " & FormatNumber(gralcomis - comislp, 2)
        ...
        With TrsIVAVentas
            Do While Not rsEncabFact.EOF
                ...
                Else
                    ...
                    End If
                        If rsDetFact.EOF Then
                            .Fields("Neto") = rsEncabFact!TotalNetofe
    ...
    End With
        ...
        Do While Not rsEncabFact.EOF
            ...
            Do While Not rsDetFact.EOF
                ...
                .Fields("PtoVta") = rsEncabFact!PtoVtaFE
...
Do While Not rsEncabFact.EOF
    ...
    'FECHA DE PAGO
        ...
        If Not rsEncabFact!tIPOSISTEMA = 201 And Not rsEncabFact!tIPOSISTEMA = 60 Then
            Vfecha = rsEncabFact!FPago
            VFechaPago = Vfecha
        Else
        VFechaPago = "00000000"
...
Set rsEncabFact = db.OpenRecordset("SELECT * FROM EncabFE WHERE FechaFE BETWEEN # " + Format(FDESDE, "mm/dd/yyyy") + " # AND # " + Format(FHASTA, "mm/dd/yyyy") + " # ORDER BY FechaFE")
Do While Not rsEncabFact.EOF
    If Not rsEncabFact!tIPOSISTEMA = 17 And Not rsEncabFact!tIPOSISTEMA = 203 And Not rsEncabFact!tIPOSISTEMA = 20 Then
        Set rsDetFact = db.OpenRecordset("Select * From DetFE Where NroFact = " & rsEncabFact!NroFE & " and TipoComp = " & rsEncabFact!TipoAfip & "  and PtoVta = " & rsEncabFact!PtoVtaFE & "")
        Do While Not rsDetFact.EOF
            If rsDetFact!PtoVta = 4 Then
                ...
                Else
                    ...
                    If rsEmpresas.EOF Then
                        ...
                        .Fields("DescEmpresa") = rsEmpresas!DescFlet
                    Else
                        .Fields("DescEmpresa") = rsEmpresas!DescEmpresas
                    End If
                    ...
                    .Fields("PtoVta") = rsEncabFact!PtoVtaFE
                    .Fields("TipoComp") = rsEncabFact!tIPOSISTEMA
                    Set rsComprobantes = db.OpenRecordset("Select * From Comprobantes Where CodComp = " & rsEncabFact!tIPOSISTEMA & "")
                    .Fields("DescComp") = rsComprobantes!DescComp
    ...
    Else
         With TrsLPVsFact
                    ...
                    .Fields("Diferencia") = 0
                    .Fields("CodEmpresa") = rsEncabFact!CodClie
                    If rsEncabFact!tIPOSISTEMA = 17 Then
                         If rsEncabFact!Emp_Flet = 0 Then
                             Set rsEmpresas = db.OpenRecordset("Select * From Empresas Where CodEmpresas = " & rsEncabFact!CodClie & "")
                            .Fields("DescEmpresa") = rsEmpresas!DescEmpresas
                         Else
